...
import { ThemeProvider, PartialTheme, Stack, IStackTokens } from '@fluentui/react';
...
import { IInputs } from '../../../../DocumentManager/DocumentManagerControl/generated/ManifestTypes';
...
export const CustomComponent: React.FC<ICustomComponent> = props => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Stack tokens={stackTokens}>
        ...
        <ScrollablePane className='' style={{ height: '400px', display: 'block', position: 'static' }}>
          <List items={filteredDocuments} onRenderCell={(item, index) => (item ? renderDocument(item, index!) : null)} />
        </ScrollablePane>
